...
public class Layers {
    // from https://github.com/MylesAndMore/Tumble/blob/main/src/main/java/com/MylesAndMore/Tumble/game/Layers.java

    public Layers() {
        List<Material> gen2 = new ArrayList<Material>() {{
        ...
        List<Material> gen4 = new ArrayList<Material>() {{
        ...
        List<Material> gen5 = new ArrayList<Material>() {{
            add(Material.WHITE_TERRACOTTA);
        ...
        List<Material> gen7 = new ArrayList<Material>() {{
        ...
        List<Material> gen9 = new ArrayList<Material>() {{
        ...
        List<Material> gen10 = new ArrayList<Material>() {{
        ...
        List<Material> gen1 = new ArrayList<Material>() {{
        ...
        for (int i = 0; i < 3; i++) {
            List<Material> gen0 = new ArrayList<Material>() {{
            ...
            matList.add(gen1);
            matList.add(gen2);
            List<Material> gen3 = new ArrayList<Material>() {{
            ...
            matList.add(gen4);
            matList.add(gen5);
            List<Material> gen6 = new ArrayList<Material>() {{
            ...
            matList.add(gen6);
            matList.add(gen7);
            List<Material> gen8 = new ArrayList<Material>() {{
                add(Material.REDSTONE_BLOCK);
                add(Material.REDSTONE_BLOCK);
            ...
            matList.add(gen9);
            matList.add(gen10);
            List<Material> gen12 = new ArrayList<Material>() {{
                add(Material.DIRT);
            ...
            matList.add(gen12);
            List<Material> gen14 = new ArrayList<Material>() {{
            ...
            matList.add(gen14);
            List<Material> gen15 = new ArrayList<Material>() {{
            ...
            matList.add(gen15);
            List<Material> gen16 = new ArrayList<Material>() {{
    ...
    // Template:
    // private final List<Material> gen = new ArrayList<Material>() {{
    // add(Material.
    // }};
