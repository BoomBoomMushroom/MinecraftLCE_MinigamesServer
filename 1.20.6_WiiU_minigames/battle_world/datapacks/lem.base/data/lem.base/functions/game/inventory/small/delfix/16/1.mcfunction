...
item replace block -335 66 -323 container.0 from entity @s inventory.1
...
execute if data entity @s {Inventory:[{Slot:10b}]} run data modify entity @e[type=item,limit=1,sort=nearest,tag=smallinvdelfixtemp] Item set from block -335 66 -323 Items[0]
...
execute if data entity @s {Inventory:[{Slot:10b}]} run item replace block -335 66 -323 container.0 with air
