...
public class LobbyManagerSetLobbyWorldCommand implements CommandExecutor {
    private final LobbyManager main;
    public LobbyManagerSetLobbyWorldCommand(LobbyManager main){
        this.main = main;
    }
    @Override
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if(preWorldQuery != null){
            main.fileSaveData.setDataFileKey(LobbyManagerConstants.lobbyWorldKeyName, preWorldQuery.getName());
        }
        else{
            WorldCreator creator = new WorldCreator(worldFolderName);
            World createdWorld = main.server.createWorld(creator);

            main.fileSaveData.setDataFileKey(LobbyManagerConstants.lobbyWorldKeyName, createdWorld.getName());
        }
